...
class NodeConfig(BaseModel):
    ...
    model_name: str = Field("gpt-4o-mini", description="Name of the model to use")
    temperature: float = Field(0.7, description="Temperature parameter for model generation")
